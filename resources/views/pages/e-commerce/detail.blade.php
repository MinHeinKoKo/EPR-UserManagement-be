        ...
        <div class="flex flex-col justify-center gap-y-10 w-full">
            <div class="flex items-center justify-evenly">
                <div class="flex-1">
                    <img src="https://images.unsplash.com/photo-1594385208974-2e75f8d7bb48?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                        class="w-[350px] mx-auto object-cover aspect-square rounded-md shadow-sm" alt="product" />
                </div>
                <div class="flex-1">
                    <div class="flow-root">
            ...
            <div class="max-w-4xl mx-auto">
                <ul class="list-disc flex flex-col gap-y-5">
                    <li>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis, quo! Recusandae dolore, sed,
                        dignissimos numquam aliquid asperiores dolor eveniet laboriosam quasi quidem incidunt debitis
                        perferendis est, quod et minima tempora!
                    </li>
                    <li>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis, quo! Recusandae dolore, sed,
                        dignissimos numquam aliquid asperiores dolor eveniet laboriosam quasi quidem incidunt debitis
