...
@section('content')
<main class="max-w-7xl h-auto w-full mx-auto">
  <section class="relative block h-[500px]">
    ...
    <div class="top-auto bottom-0 left-0 right-0 w-full absolute overflow-hidden h-70-px" style="transform: translateZ(0px)">
        ...
        <div class="px-6">
          <div class="flex flex-wrap justify-center">
            <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
              <div class="relative">
                <img alt="..." src="https://demos.creative-tim.com/notus-js/assets/img/team-2-800x800.jpg" class="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-10 max-w-[250px]">
              </div>
            </div>
